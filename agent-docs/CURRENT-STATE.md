...
- `features/seo-intelligence/` owns deterministic keyword normalization, Keyword Planner import parsing, clustering, and opportunity classification. `npm run seo:opportunities` combines this with 90-day GSC evidence and optional read-only Google Ads API data without publishing content or mutating campaigns.
