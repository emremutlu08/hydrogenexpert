...
Owner: Agent
Source of truth: User instruction, current repo, release history
...
6. Read `agent-docs/CONTENT-GOVERNANCE.md` before creating or materially updating Shopify, Hydrogen, Oxygen, Storefront API, Customer Account API, Storefront MCP, UCP, SEO, analytics, or migration content.
