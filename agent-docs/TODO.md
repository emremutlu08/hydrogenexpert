...
1. Move large content registries out of `lib/` into feature/domain folders with compatibility exports as needed.
2. Review direct-composed pages for real repeated section patterns and extract only where DRY/KISS improves.
3. Update `agent-docs/CURRENT-STATE.md`, `REPO-STRUCTURE.md`, and `DECISIONS.md` after each architecture phase.
