  ...
  const links = {
    eveshop: [
      ...
      },
      {
        ...
        note: "Agency-alternative path for teams comparing headless storefront options.",
      },
      {
    ...
    bayam: [
      ...
      },
      {
        href: "/headless-shopify-agency",
        label: "Headless Shopify storefront support",
        note: "Agency-alternative path when luxury catalog discovery needs headless judgment.",
      },
      {
        href: "/shopify-hydrogen-seo",
        label: "Shopify Hydrogen SEO-safe implementation",
    ...
    "rebel-bunny": [
      ...
      },
      {
        href: "/headless-shopify-agency",
        label: "Headless Shopify storefront support",
        note: "Agency-alternative path for teams comparing direct senior ownership with a vendor layer.",
      },
      {
        href: "/shopify-hydrogen-seo",
        label: "Shopify Hydrogen SEO-safe implementation",
