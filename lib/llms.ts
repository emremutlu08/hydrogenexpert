...
function buildHeader() {
  ...
  return [
    `# ${host}`,
    "",
    `> HydrogenExpert is a senior-led Shopify Hydrogen service led by ${OWNER.name}, focused on fixed-scope Hydrogen storefront builds, scope reviews, migrations, custom storefront development, performance, SEO, and support.`,
    "",
  ].join("\n");
}
...
function buildSummary() {
  return [
    ...
    "- Delivery model: Direct work with Emre Mutlu from scope review to launch, with fixed-scope builds and separately scoped complex migrations",
